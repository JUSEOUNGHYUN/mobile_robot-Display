...
static const _MdRobotUserParam_type_support_symbol_names_t _MdRobotUserParam_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, md_interfaces, msg, MdRobotUserParam)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, md_interfaces, msg, MdRobotUserParam)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, md_interfaces, msg, MdRobotUserParam)() {
  return &::md_interfaces::msg::rosidl_typesupport_c::MdRobotUserParam_message_type_support_handle;
}
